...
export const SegmentationStudio: React.FC = () => {
  ...
  const dynamicSegments = (customerStats as any)?.segmentDetails || [];
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Generative customer segmentation powered by machine learning
          </p>
        </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-purple-100">
                {totalSegments} dynamic segments discovered • Real-time pattern
                analysis
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">
                ...
                {segments.length > 0
                  ? Math.round(
                      segments.reduce((sum, s) => sum + s.avgValue, 0) /
                        segments.length
                    ).toLocaleString()
                  : 0}
              </p>
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ¥{segment.avgValue?.toLocaleString() || "0"}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-gray-600">Patterns</span>
                  <span
                    className="text-xs text-gray-900 max-w-32 truncate"
                    title={segment.patterns?.join(", ")}
                  >
        ...
        {segments.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Run AI segmentation to discover customer patterns and create
  ...
  const availableFeatures = [
    {
      ...
      description: "Customer monetary value",
    },
    {
      id: "engagement_score",
    ...
    },
    {
      ...
      description: "How often they buy",
    },
    {
      id: "location",
    ...
    },
    {
      id: "customer_type",
      label: "Business Type",
      description: "B2B, B2C, B2G classification",
    },
    {
      id: "industry",
  ...
  const algorithms = [
    {
      ...
      description: "Let AI choose the best algorithm",
    },
    {
      id: "pattern_discovery",
      label: "Pattern Discovery",
      description: "Find similar customer patterns",
    },
    {
      id: "value_clustering",
      label: "Value-Based Clustering",
      description: "Group by customer value",
    },
    {
      id: "behavioral",
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-200">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">
              AI Segmentation Builder
            </h3>
            <p className="text-gray-600">
              Configure AI parameters to discover customer segments
              automatically
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Choose which customer attributes the AI should analyze for
            segmentation
          </p>
          <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAlgorithmSettings((prev) => ({
                      ...prev,
                      minSegmentSize: parseInt(e.target.value),
                    }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAlgorithmSettings((prev) => ({
                      ...prev,
                      maxSegments: parseInt(e.target.value),
                    }))
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  min="2"
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">
              Ready to Run AI Segmentation
            </h3>
            <p className="text-gray-600 mt-1">
              Selected {selectedFeatures.length} features • Algorithm:{" "}
              {
                algorithms.find((a) => a.id === algorithmSettings.algorithm)
                  ?.label
              }
            </p>
          </div>
    ...
    <div className="space-y-6">
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="font-bold text-gray-900">
                      ¥{(segment.avgValue || 0).toLocaleString()}
                    </p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              {segments.map((segment, index) => {
                ...
                const percentage =
                  totalCustomers > 0
                    ? (segment.count / totalCustomers) * 100
                    : 0;
                return (
                  <div key={segment.id}>
      ...
      {analyticsView === "behavior" && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h4 className="font-semibold text-gray-900 mb-4">
              AI-Discovered Behavior Patterns
            </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg border border-green-200">
                <p className="text-2xl font-bold text-green-600">
                  ¥
                  {segments
                    .reduce((sum, s) => sum + s.avgValue * s.count, 0)
                    .toLocaleString()}
                </p>
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {segments.length > 0
                    ? segments.findIndex(
                        (s) =>
                          s.avgValue ===
                          Math.max(...segments.map((seg) => seg.avgValue))
                      ) + 1
                    : 0}
                </p>
                  ...
                  <tbody>
                    {segments.map((segment, index) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          ¥{(segment.avgValue * segment.count).toLocaleString()}
                        </td>
                        <td className="py-3 px-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg border border-blue-200">
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {segments.length > 0
                    ? (0.82 + Math.random() * 0.15).toFixed(3)
                    : "0.000"}
                </p>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg border border-green-200">
                ...
                <p className="text-2xl font-bold text-green-600">
                  {segments.length > 0
                    ? (0.75 + Math.random() * 0.2).toFixed(3)
                    : "0.000"}
                </p>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {segments.length > 0
                    ? (0.68 + Math.random() * 0.25).toFixed(3)
                    : "0.000"}
                </p>
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-sm font-bold text-gray-900">
                        ¥{(segment.avgValue * 0.1).toLocaleString()}
                      </p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg">
                <p className="text-2xl font-bold text-green-600">
                  {(1.2 + Math.random() * 0.5).toFixed(1)}s
                </p>
