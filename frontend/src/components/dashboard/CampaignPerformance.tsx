...
import { Target, TrendingUp, Users, DollarSign, ChevronRight } from 'lucide-react'
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-gray-900">{campaignData?.summary?.active || 0}</p>
        ...
        <div className="bg-green-50 rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-green-600 font-medium">+{campaignData?.summary?.growth || 0}%</span>
          </div>
          <p className="text-2xl font-bold text-gray-900">{campaignData?.summary?.totalImpressions?.toLocaleString() || 0}</p>
        ...
        <div className="bg-purple-50 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-gray-900">{campaignData?.summary?.conversionRate || 0}%</p>
        ...
        <div className="bg-orange-50 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-gray-900">{campaignData?.summary?.roi || 0}%</p>
